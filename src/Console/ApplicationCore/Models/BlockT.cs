...
{
    public class BlockT : IPiece
    {
        public ConsoleColor ConsoleColor => ConsoleColor.DarkYellow;
        public bool[,] Matrix { get; private set; }

        private bool IsShape1 => Matrix.GetLength(0) == 2 && !Matrix[0, 0];

        private bool IsShape2 => Matrix.GetLength(0) == 3 && Matrix[0, 0];

        private bool IsShape3 => Matrix.GetLength(0) == 2 && Matrix[0, 0];

        private bool IsShape4 => Matrix.GetLength(0) == 3 && !Matrix[0, 0];
